  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      routes: {
        ...
        home: Scaffold(
        appBar: AppBar(
        title: Text('ANJU SAPUTRA HARIANJA - 2018020725 '),
        ),
        body: LoginPage(),
      ),
    );
 ...
 class LupaPass extends StatelessWidget {
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        //body
        body: Text("PASSWORD SALAH!!!!!!.. COBA KEMBALI!!!!!"));
  }
}
class ANJUDataTable extends StatefulWidget {
  _ANJUDataTableState createState() => _ANJUDataTableState();
}

class _ANJUDataTableState extends State<ANJUDataTable> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('ANJU SAPUTRA HARIANJA'),
      ),
...
class DataMahasiswa {
  ...
  static List<DataMahasiswa> getDataBarang() {
    return <DataMahasiswa>[
      DataMahasiswa(id: "Nama", namabarang: "ANJU SAPUTRA HARIANJA", ),
      DataMahasiswa(id: "Jenis Kelamin", namabarang: "Laki-Laki", ),
      DataMahasiswa(id: "Kelas", namabarang: "6 SIA 4", ),
      DataMahasiswa(id: "Alamat", namabarang: "Tanjung Morawa", ),
      DataMahasiswa(id: "No.Hp", namabarang: "+62-823-6381-1398", ),
      DataMahasiswa(id: "Sekolah", namabarang: "STMIK TRIGUNA DHARMA ", ),
